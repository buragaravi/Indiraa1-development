...
const WarehouseBatchDashboard = () => {
  ...
  const calculateAnalyticsDefaults = (analyticsData) => {
    ...
    console.log('[ADMIN] Analytics with fallbacks:', fallbacks);
    return fallbacks;
  };
  ...
  const fetchAnalytics = async () => {
    try {
      ...
      console.log('[ADMIN] Raw analytics response:', JSON.stringify(data, null, 2));
      
      const processedAnalytics = calculateAnalyticsDefaults(data.data);
      console.log('[ADMIN] Processed analytics:', processedAnalytics);
