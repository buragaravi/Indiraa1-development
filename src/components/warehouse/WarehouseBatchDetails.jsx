    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Error Loading Batch Details</h3>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Warehouse Batch Details</p>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{batchGroup.statistics?.totalProducts || 0}</p>
                <p className="text-xs text-gray-400">{batchGroup.statistics?.totalItems || 0} total items</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{batchGroup.statistics?.availableItems || 0}</p>
                <p className="text-xs text-gray-400">{batchGroup.statistics?.availabilityRate || 0}% available</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{batchGroup.statistics?.utilizationRate || 0}%</p>
                <p className="text-xs text-gray-400">{batchGroup.statistics?.usedItems || 0} items used</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">Orders Served</p>
                <p className="text-2xl font-semibold text-gray-900">{batchGroup.statistics?.orderAllocationsCount || 0}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white shadow rounded-lg">
              ...
              <div className="p-6 space-y-6">
                <div>
                  <label className="block text-sm font-medium text-gray-500">Batch Group Number</label>
                  <p className="mt-1 text-sm text-gray-900 font-mono">{batchGroup.batchGroupNumber}</p>
                </div>
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-6 py-4 border-b border-gray-200">
                <h3 className="text-lg font-medium text-gray-900">Quality Status</h3>
              </div>
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm font-medium text-gray-700">Quality Checked</span>
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                    batchGroup.qualityChecked 
                      ? 'bg-green-100 text-green-800' 
                      : 'bg-yellow-100 text-yellow-800'
                  }`}>
                    {batchGroup.qualityChecked ? 'Verified' : 'Pending'}
                  </span>
                </div>
                {batchGroup.qualityCheckDate && (
                  <div className="mb-4">
                    <label className="block text-sm font-medium text-gray-500">Check Date</label>
                    <p className="mt-1 text-sm text-gray-900">{formatDate(batchGroup.qualityCheckDate)}</p>
                  </div>
                )}
                {batchGroup.qualityNotes && (
                  <div>
                    <label className="block text-sm font-medium text-gray-500">Quality Notes</label>
                    <p className="mt-1 text-sm text-gray-900">{batchGroup.qualityNotes}</p>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white shadow rounded-lg">
              <div className="px-6 py-4 border-b border-gray-200">
                <h3 className="text-lg font-medium text-gray-900">Products in this Batch</h3>
              </div>
                      ...
                      {batchGroup.products?.map((product, index) => (
                        <tr key={index} className="hover:bg-gray-50">
                            ...
                            {product.variantDetails && product.variantDetails.length > 0 ? (
                              <div className="space-y-2">
                                {product.variantDetails.map((variant, vIndex) => {
                                  ...
                                  return (
                                    <div key={vIndex} className="border rounded p-2 bg-gray-50">
                                      <div className="text-sm font-medium text-gray-700">{variant.variantName}</div>
                              ...
                              <div>
                                ...
                                <div className="w-24 bg-gray-200 rounded-full h-2">
                                  <div 
                                    className={`h-2 rounded-full ${calculateStockPercentage(product.availableQuantity, product.quantity) > 50 ? 'bg-green-500' : 'bg-yellow-500'}`}
                          ...
                          <td className="px-6 py-4">
                            {product.variantDetails && product.variantDetails.length > 0 ? (
                                ...
                                {product.variantDetails.map((variant, vIndex) => {
                                  ...
                                  return (
                                    <div key={vIndex} className="text-xs">
                                      <div className="text-gray-700">Used: {variant.usedQuantity}</div>
                                      <div className="text-gray-500">Rate: {utilizationRate}%</div>
                                    </div>
                                  );
                                })}
                              </div>
                              ...
                              <div className="text-sm">
                                <div className="text-gray-700">Used: {product.usedQuantity || 0}</div>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm font-medium text-gray-900">{product.currentStock || 0}</div>
