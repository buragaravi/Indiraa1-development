      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          {loading ? (
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-white/20 overflow-hidden shadow-md">
              {/* Desktop Table View */}
                      ...
                      <tr key={user._id} className="border-b border-gray-100/50 hover:bg-white/30 transition-colors">
                        <td className="p-4">
                          <div className="flex items-center">
                            <div className="w-10 h-10 rounded-xl bg-blue-600 shadow-md flex items-center justify-center mr-3">
              ...
              <div className="hidden lg:block xl:hidden overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50/50">
                    <tr>
                      <th className="text-left p-3 font-semibold text-gray-700 text-sm">User</th>
                      <th className="text-left p-3 font-semibold text-gray-700 text-sm">Contact</th>
                      <th className="text-left p-3 font-semibold text-gray-700 text-sm">Role</th>
                      <th className="text-left p-3 font-semibold text-gray-700 text-sm">Joined</th>
                  ...
                  <tbody>
                    {users.map((user) => (
                      <tr key={user._id} className="border-b border-gray-100/50 hover:bg-white/30 transition-colors">
                        <td className="p-3">
                          <div className="flex items-center">
                            <div className="w-8 h-8 rounded-lg bg-blue-600 shadow-md flex items-center justify-center mr-2">
              ...
              <div className="lg:hidden">
                <div className="space-y-3 p-4">
                  {users.map((user) => (
                    <div key={user._id} className="bg-white/80 backdrop-blur-sm p-4 rounded-2xl border border-white/20 shadow-md">
                      {/* Header Row */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mt-8">
            <div className="bg-white/80 backdrop-blur-sm p-4 lg:p-6 rounded-2xl border border-white/20 shadow-md">
              <div className="flex items-center">
                <div className="p-3 lg:p-4 rounded-xl bg-blue-600 shadow-md">
            ...
            <div className="bg-white/80 backdrop-blur-sm p-4 lg:p-6 rounded-2xl border border-white/20 shadow-md">
              <div className="flex items-center">
                <div className="p-3 lg:p-4 rounded-xl bg-green-600 shadow-md">
                  <PeopleIcon className="w-5 h-5 lg:w-6 lg:h-6 text-white" />
                </div>
                <div className="ml-3 lg:ml-4">
            ...
            <div className="bg-white/80 backdrop-blur-sm p-4 lg:p-6 rounded-2xl border border-white/20 shadow-md sm:col-span-2 lg:col-span-1">
              <div className="flex items-center">
                <div className="p-3 lg:p-4 rounded-xl bg-purple-600 shadow-md">
                  <PeopleIcon className="w-5 h-5 lg:w-6 lg:h-6 text-white" />
                </div>
                <div className="ml-3 lg:ml-4">
          ...
          {showUserOrders && selectedUser && (
            <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-white/90 backdrop-blur-sm max-w-5xl w-full mx-auto p-4 lg:p-8 rounded-3xl max-h-[90vh] overflow-y-auto shadow-lg border border-white/20">
                <div className="flex justify-between items-center mb-4 lg:mb-6">
                  <h2 className="text-xl lg:text-2xl font-bold text-gray-800 flex items-center">
                    <span className="w-2 h-6 lg:h-8 bg-blue-600 rounded-full mr-2 lg:mr-3"></span>
                    ...
                    {userOrders.length > 0 ? (
                      <div className="space-y-4">
                        {userOrders.map((order) => (
                          <div key={order._id} className="bg-white/80 backdrop-blur-sm p-4 lg:p-6 rounded-2xl border border-white/20 shadow-md">
